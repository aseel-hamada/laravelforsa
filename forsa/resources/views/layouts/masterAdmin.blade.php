            ...
            <li class="nav-item nav-profile">
              <a  href="{{url('/admin_home')}}" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column px-3">
                  <span class="font-weight-bold mb-2">محمد الأحمد</span>
                  <!-- <span class="text-secondary text-center text-small">ux/ui</span> -->
                </div>
              </a>
            </li>
            {{-- //{{ Request::routeIs('/admin_home') ? 'span_active' : '' }} --}}
            {{-- {{request()->routeIs('/admin_home') }} --}}
            <li class="nav-item">
              <a class="nav-link {{ request()->routeIs('/admin_home') ? 'span_active':'' }} " href="{{url('/admin_home')}}">
                <i class="fa-solid fa-house fa-lg text-black "></i>
                <span class="menu-title mx-2" style=" font-size: 17px;">الرئيسية</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ request()->routeIs('/companyAdmin') ? 'span_active':'' }}" href="{{url('/companyAdmin')}}"  >
                <i class="fa-solid fa-building fa-xl text-black"></i>
                <span class="menu-title mx-2" style="font-size: 17px;">الشركات</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="{{url('/studentAdmin')}}">
                <i class="fa-solid fa-user-group fa-lg text-black"></i>
                <span class="menu-title mx-2" style="font-size: 17px;">المتدربين</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('/aplicantAdmin')}}">
                <i class="fa-solid fa-pen-to-square fa-lg text-black"></i>
                <span class="menu-title mx-2" style="font-size: 17px;">الطلبات</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('/specialtyAdmin')}}">
                <i class="fa-solid fa-layer-group fa-lg text-black"></i>
                  <span class="menu-title mx-2" style="font-size: 17px;">التخصصات</span>
              </a>
            </li>
