...
@section('styles')
<link rel="stylesheet" href="{{asset('assets/css/admin-company.css')}}">
    ...
    <div class="content-wrapper">
      ...
      <div class="box mt-3">
        <form class="d-flex justify-content-center align-items-center" name="search">
            ...
            <button class=" btn_ser btn text-white " >
      ...
      <div class="container d-flex justify-content-center bg_table">
        <div class="table-wrap">
            <table class="table  table-responsive">
                <thead>
                    <tr>
                        <th class="text-center py-4">اسم الشركة</th>
                ...
                <tbody>
                    <tr class="align-middle alert" role="alert">
                        <td class="py-3">
                            <div class="d-flex align-items-center img">
                                ...
                                <div class="px-2">
                                    <div class=" pb-1 text-center"> نيو لاين تكنولوجي</div>
                                </div>
                            </div>
                        </td>
                        <td class="py-3">
                            <div class="text-center"> newline@gmail.com </div>
                        </td>
                        <td class="py-3 d-flex justify-content-center">
                          <div class="d-inline-flex align-items-center  to_do">
                              <div class=" p-2">مقبولة</div>
                          </div>
                        </td>
                        <td class="py-3">
                    ...
                    <tr class="align-middle alert" role="alert">
                        <td class="py-3">
                            <div class="d-flex align-items-center img">
                                <div class="img-container">
                                    <img  src="{{asset('assets/images/hexa.png')}}"
                                        alt="">
                                </div>
                                <div class="px-2">
                                    <div class=" pb-1 text-center"> هكسا</div>
                                </div>
                            </div>
                        </td>
                        <td class="py-3">
                            <div class="text-center"> hexa@gmail.com</div>
                        </td>
                        <td class="py-3 d-flex justify-content-center">
                          <div class="d-inline-flex align-items-center   activeB">
                              <div class=" p-2"><a style="color:#148F78" href="#" >قبول</a></div>
                          </div>
                        </td>
                        <td class="py-3">
                            <div class="text-center">
