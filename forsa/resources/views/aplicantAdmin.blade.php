...
@section('content')
@section('styles')
<link rel="stylesheet" href="{{asset('assets/css/admin-aplicant.css')}}">
@endsection
      ...
      <div class="container d-flex justify-content-center bg_table">
        <div class="table-wrap">
            <table class="table table-responsive">
                <thead>
                    <tr>
                        <th class="text-center py-4"> صورة</th>
                        ...
                        <td class="py-3">
                          <div class="d-flex align-items-center img">
                            <div class="img-container">
                                <img  src="{{asset('assets/images/face1.jpg')}}"alt="">
                            </div>
                            <div class="px-2">
                                <div class=" pb-1 text-center"> محمد الأحمد</div>
                            </div>
                        </div>
                        </td>
