...
@section('content')
@section('styles')
<link rel="stylesheet" href="{{asset('assets/css/company-requests.css')}}">
@endsection
              ...
              <table class="table table-responsive">
                  <thead>
                    <tr>
                      ...
                      <tr>
                          <th class="py-4 text-right" > صورة</th>
                          <th class="text-center py-4"> نبذة</th>
                  ...
                  <tbody>
                      <tr class="align-middle alert" role="alert">
                          <td class="py-3">
                              <div class="d-flex align-items-right img">
                                  <div class="img-container image">
                                      <img src="../assets/images/face1.jpg" alt="" ><span>محمد احمد</span>
                                  </div>
                              </div>
                          </td>
                          ...
                          <td class="py-3">
                              <div class="text-wrap">
                                  <p>أنا مصمم UX UI قادر على انجاز مواقع ويب ذات ألوان مميزة حيث تتوافق مع أساسيات ومبادئ تجربة المستخدم.
                                    حيث يمكنني اجراء جميع التعديلات التي تريدينها وإخراج تصميم بدقة وجودة عالية.
                                  </p>
                              </div>
                          </td>
                          <td class="py-3 status-icon">
                          <a href="#">
                            <svg data-bs-toggle="tooltip" data-placement="left" title="قبول" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#A0FABF" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="margin-right: 5px;">
                              <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                           </svg>

                          </a>

                          <a href="{{url('/profileStudent')}}">
